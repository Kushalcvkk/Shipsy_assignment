...
//       {/* Expense Form */}
//       <div className="bg-white dark:bg-gray-900 p-6 mb-6 rounded-lg shadow max-w-md">
...
//         <label className="block mb-1 text-sm font-medium">Unit Amount</label>
//         <input
//           type="number"
//           step="0.01"
//           min="0"
...
//             <p className="text-xs">Unit Price: ${form.amount.toFixed(2)} × {form.quantity} = ${(form.amount * form.quantity).toFixed(2)}</p>
//             {form.discount > 0 && (
...
//             )}
//             <p className="text-sm font-bold">Effective Amount: ${calculateEffectiveAmount(form.amount, form.quantity, form.taxPercent, form.discount).toFixed(2)}</p>
//           </div>
//         )}

//         <button onClick={handleSubmitExpense} className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
//           {form.id ? "Update" : "Add"}
//         </button>
//       </div>
...
//           {/* Search */}
//           <div>
//             <label className="block mb-1 text-sm font-medium">Search Title</label>
//             <input
//               type="text"
//               placeholder="Search expenses..."
//               value={filters.searchTerm}
//               onChange={(e) => setFilters({ ...filters, searchTerm: e.target.value })}
//               className="w-full p-2 border border-gray-400 rounded text-black dark:text-white dark:bg-gray-800"
//             />
//           </div>
...
//           {/* Amount Range */}
//           <div>
//             <label className="block mb-1 text-sm font-medium">Min Amount</label>
//             <input
//               type="number"
//               step="0.01"
//               placeholder="0.00"
...
//           <div>
//             <label className="block mb-1 text-sm font-medium">Max Amount</label>
//             <input
//               type="number"
//               step="0.01"
...
//           {/* Recurring Filter */}
//           <div>
//             <label className="block mb-1 text-sm font-medium">Recurring</label>
//             <select
...
//             <tr>
//               <th 
//                 className="px-4 py-2 text-left cursor-pointer hover:bg-blue-600 dark:hover:bg-gray-700"
...
//               </th>
//               <th 
//                 className="px-4 py-2 text-right cursor-pointer hover:bg-blue-600 dark:hover:bg-gray-700"
...
//               <th className="px-4 py-2 text-right">Effective Amount</th>
//               <th 
//                 className="px-4 py-2 text-center cursor-pointer hover:bg-blue-600 dark:hover:bg-gray-700"
...
//                   <td className="px-4 py-2 text-right">${Number(exp.amount || 0).toFixed(2)}</td>
//                   <td className="px-4 py-2 text-right">{quantity}</td>
//                   <td className="px-4 py-2 text-right">${subtotal.toFixed(2)}</td>
//                   <td className="px-4 py-2 text-right">{Number(exp.taxPercent || 0)}%</td>
//                   <td className="px-4 py-2 text-right">{Number(exp.discount || 0)}%</td>
//                   <td className="px-4 py-2 text-right font-semibold text-green-600">${effectiveAmount.toFixed(2)}</td>
...
//                     <button onClick={() => handleEdit(exp)} className="bg-yellow-400 px-2 py-1 rounded hover:bg-yellow-500 transition text-black text-sm">
//                       Edit
//                     </button>
//                     <button
//                       onClick={() => handleDelete(exp.id)}
//                       className="bg-red-500 px-2 py-1 text-white rounded hover:bg-red-600 transition text-sm"
//                     >
//                       Delete
//                     </button>
//                   </td>
...
//           {categories.map((cat) => (
//             <div key={cat} className="mb-3 p-3 border border-gray-200 dark:border-gray-700 rounded">
...
//               <p>Recurring Expenses: {filteredExpenses.filter(e => e.isRecurring).length}</p>
//             </div>
//           </div>
//         </div>
//       </div>
